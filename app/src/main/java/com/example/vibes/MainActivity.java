...
import com.example.vibes.activities.PlayerDialog;
import com.example.vibes.activities.QueueDialog;
import com.example.vibes.adapter.MainPagerAdapter;
import com.example.vibes.dialogs.SleepTimerDialog;
import com.example.vibes.dialogs.SleepTimerDisplayDialog;
import com.example.vibes.helper.MusicLibraryHelper;
import com.example.vibes.helper.PermissionHelper;
import com.example.vibes.helper.ThemeHelper;
import com.example.vibes.listener.MusicSelectListener;
import com.example.vibes.listener.PlayerDialogListener;
import com.example.vibes.listener.SleepTimerSetListener;
import com.example.vibes.model.Music;
import com.example.vibes.player.PlayerBuilder;
import com.example.vibes.player.PlayerListener;
import com.example.vibes.player.PlayerManager;
import com.example.vibes.viewmodel.MainViewModel;
...
public class MainActivity extends AppCompatActivity
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.control_play_pause) playerManager.playPause();

        else if (id == R.id.control_queue) setUpQueueDialogHeadless();

        else if (id == R.id.player_layout) setUpPlayerDialog();
    }
