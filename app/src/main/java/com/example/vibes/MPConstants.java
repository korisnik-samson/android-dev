...
public class MPConstants {
    public static final String PACKAGE_NAME = "com.example.vibes";
    public static final String DEBUG_TAG = "Vibes_debug";
    public static final String GITHUB_REPO_URL = "https://github.com/korisnik-sam/springapp";
    ...
    public static MainActivity musicSelectListener;
}
